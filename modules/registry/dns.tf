...
resource "azurerm_dns_mx_record" "registry_" {
  name                = var.subdomain
...
resource "azurerm_dns_txt_record" "registry_spf" {
  name                = var.subdomain
  resource_group_name = var.dns_resource_group_name
  zone_name           = var.root_zone_name
  ttl                 = 300
...
resource "azurerm_dns_txt_record" "registry_dkim" {
...
resource "azurerm_dns_txt_record" "registry_dmarc" {
